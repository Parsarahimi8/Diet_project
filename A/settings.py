...
SECRET_KEY = 'django-insecure-w3)8y574y0@dwgm35x$r$s$v7)m3jdi=@q*$a=rjleup3^*=^&'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'parsarahimi.shakar@gmail.com'  # replace with your Gmail
EMAIL_HOST_PASSWORD = 'ivpw syhe gckc omrf'  # generate App password in Gmail
